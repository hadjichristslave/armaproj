...
<link media="all" type="text/css" rel="stylesheet" href="http://armancon.com/azadmin/myproject/public/css/customStyle.css">
<!-- END THEME STYLES -->
<!-- Login styles	-->
			...
			<ul class="page-sidebar-menu">
				...
				<li class="">
					...
					<ul class="sub-menu" style="display: none;">
						...
						<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="Δημιουργία χρήστη πλατφόρμας">
							<a href="http://armancon.com/azadmin/myproject/public/app/View/singleOrder">
								<span class="title">
